...
describe('Testing the binary function' , ()=>
{
	...
	test('Testing for number,number argument should return the sum',()=>{expect(binary(1,-2)).toBe(-1);});
	...
	test('Testing for no arguments should return null',()=>{expect(binary()).toBe(null);});
